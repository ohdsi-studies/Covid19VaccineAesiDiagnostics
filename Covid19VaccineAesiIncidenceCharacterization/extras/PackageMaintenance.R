...
#
# This file is part of Covid19VaccineAesiIncidenceCharacterization19VaccineAesiIncidenceCharacterization19VaccineAesiIncidenceCharacterization
#
...
OhdsiRTools::updatePackageNameFolder(packageName = "Covid19VaccineAesiIncidenceCharacterization",
                                     recursive = T)
...
packageSqlFiles <- list.files(system.file(file.path("sql/sql_server/"),
                                          package = "Covid19VaccineAesiIncidenceCharacterization"), recursive = TRUE)
