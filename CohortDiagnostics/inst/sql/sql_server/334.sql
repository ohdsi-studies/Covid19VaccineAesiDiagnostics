...
delete from @result_database_schema.cohort_inclusion_result where cohort_definition_id = 334 and mode_id = 0;
...
delete from @result_database_schema.cohort_inclusion_stats where cohort_definition_id = 334 and mode_id = 0;
...
CROSS JOIN (select count(*) as total_rules from @result_database_schema.cohort_inclusion where cohort_definition_id = 334) RuleTotal
...
-- calculate totals
delete from @result_database_schema.cohort_summary_stats where cohort_definition_id = 334 and mode_id = 0;
...
-- calculte matching group counts
delete from @result_database_schema.cohort_inclusion_result where cohort_definition_id = 334 and mode_id = 1;
insert into @result_database_schema.cohort_inclusion_result (cohort_definition_id, inclusion_rule_mask, person_count, mode_id)
...
-- calculate gain counts 
delete from @result_database_schema.cohort_inclusion_stats where cohort_definition_id = 334 and mode_id = 1;
insert into @result_database_schema.cohort_inclusion_stats (cohort_definition_id, rule_sequence, person_count, gain_count, person_total, mode_id)
...
-- calculate totals
delete from @result_database_schema.cohort_summary_stats where cohort_definition_id = 334 and mode_id = 1;
insert into @result_database_schema.cohort_summary_stats (cohort_definition_id, base_count, final_count, mode_id)
